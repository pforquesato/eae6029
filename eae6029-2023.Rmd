...
Three (3) lists of exercises, graded, **worth 10% of final grade each**, one per topic. One exam, **worth 70% of the final grade**, based on the lists and class material: 5 points applied/interpretative, 1 question from the list with small changes, 1 new analytical question.
