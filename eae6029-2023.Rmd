...
1. **The ordinary least squares estimator:** asymptotic properties; conditional expectations and linear projections; inference and hypothesis testing; heteroskedasticity and clustered sampling. *Bibliography:* Hansen (2022): ch. 2 (up to 2.25), ch. 3 (up to 3.18), ch. 4, ch. 7.1-7.3 and 7.12-14, and ch. 9 (up to 9.10 and 9.20). [[Slides]](https://www.pedroforquesato.com/eae6029/eae6029-week-1.html) [[Exercise list]](https://www.pedroforquesato.com/eae6029/eae6029-lista-1.html).

2. **Instrumental variables and causal effects:** identification: Rubin causal model and potential outcomes; omitted variable bias and measurement errors; properties of the estimator and two-stages least squares; average and local average treatment effects; control functions and specification tests. Regression in discontinuity design. *Bibliography:* Hansen (2022): ch. 12. [[Slides]](https://www.pedroforquesato.com/eae6029/eae6029-week-2.html) [[Exercise list]](https://www.pedroforquesato.com/eae6029/eae6029-lista-2.html).

3. **Panel data:** Panel data and pooled linear regression; fixed effects and random effects models; first differencing and lagged dependent variables. Difference-in-differences. *Bibliography:* Hansen (2022). ch. 17 and ch. 18. [[Slides]](https://www.pedroforquesato.com/eae6029/eae6029-week-3.html) [[Exercise list]](https://www.pedroforquesato.com/eae6029/eae6029-lista-3.html).
...
Three (3) lists of exercises, graded, **worth 10% of final grade each**, one per topic. One exam, **worth 70% of the final grade**, based on the lists and class material: 5 points applied/interpretative, 1 question from the list with small changes, 1 new analytic question.
[[Exam 2023]](https://www.pedroforquesato.com/files/eae6029_prova_2023.pdf)
...
The teaching assistant for this course will be [Felipe Santos](felipe.gsantos@usp.br). Please schedule a weekly session with him.
